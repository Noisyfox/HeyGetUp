...
public class AdapterBusLine extends BaseAdapter {
	private List<BusLineInfo> resource;// 要绑定的数据
	...
	public AdapterBusLine(Context context, List<BusLineInfo> res) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		BusLineInfo info = resource.get(position);
		thisView.setTag(info);
		nameView.setText(info.mBusName);
		// disView.setText(" 相距约"
