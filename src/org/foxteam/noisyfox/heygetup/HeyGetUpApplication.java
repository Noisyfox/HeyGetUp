...
public class HeyGetUpApplication extends Application {
	public static final String strKey = "334583f93d7a6d4b2645c75a2e6d371e";
	...
	private static HeyGetUpApplication mInstance = null;
	...
	public static HeyGetUpApplication getInstance() {
		return mInstance;
	}
	...
	static class MyGeneralListener implements MKGeneralListener {
		...
		public void onGetNetworkState(int iError) {
			if (iError == MKEvent.ERROR_NETWORK_CONNECT) {
				Toast.makeText(
						HeyGetUpApplication.getInstance()
